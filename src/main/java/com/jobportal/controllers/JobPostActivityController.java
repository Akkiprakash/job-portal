        ...
        if (!(authentication instanceof AnonymousAuthenticationToken)) {
            ...
            if (authentication.getAuthorities().contains(new SimpleGrantedAuthority("Recruiter"))) {
                if (currentUserProfile instanceof RecruiterProfile recruiterProfile) {
                    ...
                    model.addAttribute("jobPost", List.of());
                }
            } else {
                List<JobSeekerApply> jobSeekerApplyList = (currentUserProfile instanceof JobSeekerProfile seekerProfile)
                        ? jobSeekerApplyService.getCandidatesJobs(seekerProfile)
                        : List.of();
                List<JobSeekerSave> jobSeekerSaveList = (currentUserProfile instanceof JobSeekerProfile seekerProfile)
                        ? jobSeekerSaveService.getCandidatesJob(seekerProfile)
                        : List.of();
